namespace RoRamu.Utils.Messaging
{
    ...
    public class Message
    {
        ...
        /// <summary>
        /// Deserializes a JSON string into a <see cref="RoRamu.Utils.Messaging.Message" /> object.
        /// </summary>
        /// <param name="json">The JSON string to deserialize.</param>
        /// <returns>The deserialized <see cref="RoRamu.Utils.Messaging.Message" /> object.</returns>
